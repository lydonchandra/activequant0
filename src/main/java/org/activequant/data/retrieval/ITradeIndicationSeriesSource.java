 ...
 * <br>
 * <b>History:</b><br>
 *  - [11.07.2007] Created (Erik Nijkamp)<br>
 *  - [25.09.2007] Switch to InstrumentQuery etc. (Erik Nijkamp) <br>
 *  - [28.09.2007] Moved to new domain model (Erik Nijkamp)<br>
 *  - [01.10.2007] Readded SeriesSpecification<br>
 *  - [15.10.2007] Cleanup, removed misleading methods (Ulrich Staudinger)<br>
 *  - [17.10.2007] Added generic super interface (Erik Nijkamp)<br>
 *
 *  @author Erik Nijkamp
 *  @author Ulrich Staudinger
 */
public interface ITradeIndicationSeriesSource extends ISeriesDataSource<TradeIndicationSeries> {
