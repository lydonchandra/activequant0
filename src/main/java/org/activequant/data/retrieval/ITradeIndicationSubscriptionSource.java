 ...
 *  - [04.11.2007] Renaming listener to I*Listener to have it naming conform (Ulrich Staudinger)<br>
 *  
 ...
 *
 */
public interface ITradeIndicationSubscriptionSource {

	ISubscription<TradeIndication> subscribe(InstrumentSpecification spec) throws Exception;
	 ...
	 */
	ISubscription<TradeIndication>[] getSubscriptions();
