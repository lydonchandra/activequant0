 ...
 *
 */
public interface ICandleSubscriptionSource {

	ISubscription<Candle> subscribe(InstrumentSpecification spec, TimeFrame timeFrame) throws Exception;
	 ...
	 */
	ISubscription<Candle>[] getSubscriptions();
